...
<button x-init {{ $current == 1 ? 'disabled' : '' }}
    {{ $attributes->merge([
        'class' => 'inline-flex px-0 gap-0 size-8 items-center justify-center rounded-md text-sm hover:bg-accent hover:text-accent-text/80']) }}>
