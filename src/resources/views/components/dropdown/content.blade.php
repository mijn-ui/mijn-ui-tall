...
@php
    $base =
        'absolute transition z-10 mt-0.5 overflow-hidden rounded-md border border-main-border bg-surface text-surface-text';
@endphp

<x-slot:content>
    <div x-cloak {{ $attributes->merge(['class' => $base]) }}
        x-bind:class="{'pointer-events-none opacity-0': !dropdownOpen }"
