<div x-data="{ open: false, selectedDate: '' }" x-init="
    window.addEventListener('date-selected', e => {
        selectedDate = e.detail[0].date;
        open = false;
    });"
    class="w-full relative" id="datepicker-container">
    <mijnui:input placeholder="Pick date" class="w-4 mb-1" id="datepicker-input" readonly @click="open = !open" x-bind:value="selectedDate" />
