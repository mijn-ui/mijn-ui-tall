...
@php
    ...
    // Base input classes
    $baseClasses =
        'flex h-10 w-full rounded-md border bg-transparent px-3 py-2 text-sm outline-none placeholder:text-muted-text autofill:shadow-[inset_0_0_0px_1000px_hsl(var(--surface))] autofill:[-webkit-text-fill-color:hsl(hsl(--main-text))_!important] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring ';
    $baseClasses .= $invalid
        ? 'border-danger bg-main focus-visible:ring-danger focus-visible:ring-offset-2 focus-visible:ring-offset-main'
        : '';
